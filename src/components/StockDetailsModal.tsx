...
export const StockDetailsModal: React.FC<StockDetailsModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#0f1115] text-slate-800 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xl w-full max-w-4xl max-h-[92vh] overflow-hidden flex flex-col font-sans animate-slide-in transition-colors duration-200">
        ...
        {/* Modal Body */}
        <div className="p-5 overflow-y-auto space-y-5 bg-white dark:bg-[#0f1115]">
          
          {/* Chart Section */}
          <div className="bg-slate-50 dark:bg-[#161b22] rounded-lg p-4 border border-slate-200 dark:border-slate-800 transition-colors duration-200">
          ...
          {/* Key Statistics Grid */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 mb-2.5 flex items-center gap-2 font-mono">
              <Activity className="w-3.5 h-3.5 text-emerald-500 dark:text-emerald-400" />
              <span>{t.stockDetails.overview}</span>
            </h3>

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs">
              <div className="p-2.5 rounded bg-slate-50 dark:bg-[#161b22] border border-slate-200 dark:border-slate-800">
          ...
          <div className="p-4 rounded-lg bg-slate-50 dark:bg-[#161b22] border border-slate-200 dark:border-slate-800 space-y-3 transition-colors duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
              ...
              <button
                ...
                className="w-full py-1.5 rounded text-xs font-bold uppercase tracking-wider bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white shadow-xs transition-all flex items-center justify-center gap-1.5 font-mono"
              >
          ...
          {profile?.description && (
            <div className="text-xs text-slate-500 dark:text-slate-400 space-y-1">
              <h4 className="font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider text-[11px] font-mono">
